...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=TZ9FHbyS#hhbDJ-r-RcvoqW-h-9amiW-LotVVt2gvc6XgFjBUqso' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '2349045054729' : process.env.OWNER_NUMBER,   
